...
for (var i = 0; i < codeChunk.length; i++) {
  ...
  // Prepare button
  btn.innerHTML = "<i class='far fa-clipboard fa-lg'></i>"; // Icon to be displayed on the button

  // Inline styling - may be a new css class, to be added in the next section
  btn.style.position = "absolute";
  btn.style.right = "1em";
  btn.style.top = "0.9.5em";
  btn.style.width = "2.3em";
  btn.style.height = "2.3em";
  btn.style.padding = "0.4em";

  // Button: CSS - Add new classes
  btn.classList.add("btn", "btn--copy");
